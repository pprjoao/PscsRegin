...
import java.net.URL;
public class AlteracaoEnderecoOutroMunic {
...
@After
  ...
  @Test
  public void alteracaoEnderecoOutroMunic() {
    ...
    driver.findElement(By.id("drpnaturezaJuridica")).click();
    driver.findElement(By.id("ChkLstTipoUnidade_7")).click();
    ...
    driver.findElement(By.id("ChkLstFormaAtuacao_5")).click();
    ...
    driver.findElement(By.id("txtObjeto")).sendKeys("TRANSPORTE RODOVIARIO COLETIVO DE PASSAGEIROS, SOB REGIME DE FRETAMENTO, INTERMUNICIPAL, INTERESTADUAL E INTERNACIONAL, TRANSPORTE RODOVIARIO DE CARGA, EXCETO PRODUTOS PERIGOSOS E MUDANCAS, INTERMUNICIPAL, INTERESTADUAL E INTERNACIONAL\\nRESTAURANTE");
